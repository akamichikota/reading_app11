...
import 'package:provider/provider.dart'; // Added this line to import Provider
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  constraints: BoxConstraints(maxWidth: MediaQuery.of(context).size.width * 0.7), // 幅を調整
                                  child: Text(
                                    commentText,
